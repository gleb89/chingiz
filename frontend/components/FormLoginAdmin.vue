...
<v-container id="forml">
 <v-form @submit.prevent="sendLogin"  ref="form_com_children" lazy-validation style="padding: 1rem;">
...
import { mapState } from "vuex";
  ...
  computed: {
    ...
    sendLogin(){
        ...
        this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/admin/token-auth`, data, {
          headers: headers
        })
        .then((token) => {
