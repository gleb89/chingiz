  ...
  <div>
    <div style="margin-top:3rem" id="header__content">
      <div style="text-alignt: center; width: 100%">
        <h1 style="text-shadow: -1px 1px 0px #000000a8;">ЛУЧШИЙ СЕРВИС ОРИГИНАЛЬНЫХ ПОДАРКОВ</h1>
      
        <p style="margin-top: 1rem;">
          “...Подарки сближают сердца , вселяют в них радость....”
        </p>
        <div class="d-lg-none d-md-none d-block pt-8" style="width:100%">
                <v-btn
                @click="oncatalog()"
                depressed
                rounded
                ...
                dark
              >
                <span style="font-size: 12px">выбрать подарок</span>
              </v-btn>
        </div>
