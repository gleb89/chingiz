...
export default {
 ...
 async asyncData({ route, $axios }) {
    const reson_id = route.params.name
    let products = await $axios.get(
       `https://giftcity.kz/api/v1/present/catalog/paginations/reason?id=${reson_id}&page=1&size=20`
    );
 ...
 this.$vuetify.goTo(0)
        ...
        this.$axios
        .$get( `https://giftcity.kz/api/v1/present/catalog/paginations/reason?id=${this.reson_id}&page=${this.page}&size=20`,{
