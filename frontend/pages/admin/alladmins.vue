...
export default {
  ...
  async asyncData({ route, $axios }) {
    ...
    let admins = await $axios.get(
       `http://giftcity.kz:8001/api/v1/present/admin/`
    );
  ...
  methods: {
    ...
    bodyFormData.append('password',this.password);
      this.$axios
        .$put(`http://giftcity.kz:8001/api/v1/present/admin/password/${this.admin_pk}`, bodyFormData, {
          headers: headers,
        })
        .then((resp) => {
  ...
  deleteItemConfirm(){
    ...
    this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/present/admin/${this.admin_pk}`, {
          headers: headers,
        })
        .then((resp) => {
          console.log(resp);
    ...
    this.$axios
        .$put(`http://giftcity.kz:8001/api/v1/present/admin/${admin_id}`, bodyFormData, {
          headers: headers,
        })
        .then((resp) => {
          console.log(resp);
    ...
    this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/admin/`, data, {
          headers: headers,
        })
        .then((resp) => {
          console.log(resp);
