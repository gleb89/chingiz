...
export default {
  ...
  async asyncData({ route, $axios }) {
    ...
    let curers = await $axios.get(`http://giftcity.kz:8001/api/v1/couriers/`);
...
computed: {
  ...
  deleteItem(item,index){
    this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/couriers/${item.id}`, {
    ...
    createCurier() {
      ...
      console.log(data);
this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/couriers/`, data, {
