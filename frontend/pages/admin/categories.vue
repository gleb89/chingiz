...
export default {
  ...
  let headers = {
      ...
      this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/present/subcategories/${this.itemSub.id}`,{
          headers: headers
        })
        .then((resp) => {
  ...
  sendResetSub(){
    let headers = {
       ...
       let indd = this.indSub
      this.$axios
        .$put(`http://giftcity.kz:8001/api/v1/present/subcategories/${this.itemSub.id}?name_subcategory=${this.name_subcategory}`,{
          headers: headers
        })
        .then((resp) => {
...
createSub(){
  ...
  let headers = {
      ...
      this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/subcategories/?name_subcategory=${this.name_subcategory}&id_category=${this.itemSub.id}`,{
          headers: headers
        })
        .then((resp) => {
...
updateSerialNumb(id_one,id_two ){
      ...
      this.$axios
        .$put(`http://giftcity.kz:8001/api/v1/present/categories/update/serial/${id_one}/${id_two}`,{
          headers: headers
        })
        .then((resp) => {
      ...
      this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/categories/?category_name=${this.name_category}`,bodyFormData ,{
          headers: headers
        })
        .then((resp) => {
   ...
   let headers = {
        ...
        this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/present/categories/${this.item_id}`,{
          headers: headers
        })
        .then((resp) => {
         this.category_presents = resp
    ...
    save() {
      ...
      this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/categories/update/${this.item_id}`, bodyFormData, {
          headers: headers
        })
        .then((resp) => {
    ...
    closeDelete() {
      ...
      let headers = {
        ...
        this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/present/categories/${this.editedItem.id}`,{
          headers: headers
        })
        .then((resp) => {
         this.items = resp
