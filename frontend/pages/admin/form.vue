...
export default {
  ...
  methods: {
    createForm() {
      ...
      this.$axios
        .$post(`http://api-booking.ru/api/v1/present/form_product/`, data, {
          headers: headers,
        })
        .then((resp) => {
    ...
    save() {
      ...
      this.$axios
        .$get(
          `http://api-booking.ru/api/v1/present/form_product/update/${this.editedItem.id}?name_form=${this.editedItem.name_form}`,
          {
            headers: headers,
          }
        )
    ...
    closeDelete() {
      ...
      this.$axios
        .$delete(`http://api-booking.ru/api/v1/present/form_product/${this.editedItem.id}`, {
          headers: headers,
        })
        .then((resp) => {
          this.items = resp;
