...
export default {
  ...
  asyncData({ $axios }) {
    ...
    return $axios
      .$get(`http://giftcity.kz:8001/api/v1/present/type/`, {
        headers: headers,
      })
      .then((type_presents) => {
  ...
  methods: {
      ...
      this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/type/`,data ,{
          headers: headers
        })
        .then((resp) => {
    ...
    save() {
      ...
      this.$axios
        .$get(`http://giftcity.kz:8001/api/v1/present/type/update/${this.editedItem.id}?name_type=${this.editedItem.name_type}`, {
          headers: headers
        })
        .then((resp) => {
         console.log(resp);
    ...
    closeDelete() {
      ...
      let headers = {
        ...
        this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/present/type/${this.editedItem.id}`,{
          headers: headers
        })
        .then((resp) => {
         this.items = resp
