...
export default {
  ...
  methods: {
      ...
      this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/reason/`,data ,{
          headers: headers
        })
        .then((resp) => {
    ...
    save() {
      ...
      this.$axios
        .$get(`http://giftcity.kz:8001/api/v1/present/reason/update/${this.editedItem.id}?name_reason=${this.editedItem.name_reason}`, {
          headers: headers
        })
        .then((resp) => {
         console.log(resp);
