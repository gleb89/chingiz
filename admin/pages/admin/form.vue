...
export default {
  ...
  asyncData({ $axios }) {
    ...
    return $axios
      .$get(`http://giftcity.kz:8001/api/v1/present/form_product/`, {
        headers: headers,
      })
      .then((form_presents) => {
  ...
  methods: {
    createForm() {
      ...
      this.$axios
        .$post(`http://giftcity.kz:8001/api/v1/present/form_product/`, data, {
          headers: headers,
        })
        .then((resp) => {
    ...
    save() {
      ...
      this.$axios
        .$get(
          `http://giftcity.kz:8001/api/v1/present/form_product/update/${this.editedItem.id}?name_form=${this.editedItem.name_form}`,
          {
            headers: headers,
          }
        )
    ...
    closeDelete() {
      ...
      this.$axios
        .$delete(`http://giftcity.kz:8001/api/v1/present/form_product/${this.editedItem.id}`, {
          headers: headers,
        })
        .then((resp) => {
          this.items = resp;
