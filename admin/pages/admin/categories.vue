...
export default {
  ...
  methods: {
      ...
      this.$axios
        .$post(`http://giftcity.kz/api/v1/present/categories/`,data ,{
          headers: headers
        })
        .then((resp) => {
    ...
    save() {
      ...
      this.$axios
        .$get(`http://giftcity.kz/api/v1/present/categories/update/${this.editedItem.id}?name_category=${this.editedItem.name_category}`, {
          headers: headers
        })
        .then((resp) => {
         console.log(resp);
